...
final_df <- do.call(rbind.data.frame, rf_list) %>% 
  select(c(1:2, 5:7))
# Write to file
# write_csv(final_df, "output/residue_extraction/channelAB_regression_10_loops_0.7_split.csv")

# Plot observed vs. predicted

pdf("output/residue_extraction/example_prediction_plot.pdf", height = 3)
